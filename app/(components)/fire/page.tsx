// pages/fire-trail.tsx
"use client";
import { useState } from 'react';
import { FireTrailCursor } from 'funky-cursor'; // Ensure this is the correct import path
  ...
  return (
    <Layout>
      <div className="p-4 md:p-8">
        <h1 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4 text-center">Fire Trail Cursor</h1>
...
`}
        ...
        <div className="mt-8 border-2 border-gray-700 p-3 sm:p-4 md:p-6 relative">
          <FireTrailCursor 
            ...
            trails={trails} 
          />
          <p className="text-sm sm:text-base md:text-lg">Move your cursor around to see the fire trail effect!</p>
        </div>
      </div>
    </Layout>
  );
