...
import { GalaxyTrailCursor } from 'funky-cursor'; // Ensure this is the correct import path
  ...
  return (
    <Layout>
      <div className="p-4 md:p-8">
        <h1 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4 text-center">Galaxy Trail Cursor</h1>
        <p className="mb-4 text-sm sm:text-base md:text-lg">
          The GalaxyTrailCursor adds a galaxy-like effect to the cursor trail. Customize the properties below:
        </p>
        
        {/* Code Example Section */}
        <pre className="bg-gray-800 p-3 sm:p-4 md:p-6 rounded-md text-white text-xs sm:text-sm md:text-base overflow-auto mb-4">
          {`import { GalaxyTrailCursor } from 'funky-cursor';
...
`}
        ...
        <div className="mt-8 border-2 border-gray-700 p-3 sm:p-4 md:p-6 relative">
          <GalaxyTrailCursor 
            ...
            speed={speed} 
          />
          <p className="text-sm sm:text-base md:text-lg">Move your cursor around to see the galaxy effect!</p>
        </div>
      </div>
    </Layout>
  );
